...
#1-100, he is an 85% shooter, for 101-200, he is 84%, and so on). Write a function that returns the number of free throws that
#Donovan Mitchell makes in a day if he takes 500.
...
#500 free throws. How many of those free throws would he have to make for the Jazz not to realize the something is up (at an alpha
#level of .05)
...
#The Donovan impersonator has practiced his free throw shooting for this moment and is an 80% free throw shooter. He also exhibits
#the 1 percentage point decrease with each 100 free throws. What is the probability that Jazz will will realize the impersonator
